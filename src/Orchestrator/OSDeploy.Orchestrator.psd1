@{
    ...
    FunctionsToExport = @('Enter-Orchestrator', 'New-Checkpoint', 'Get-ResumePoint', 'Get-OrchestratorMutex',
        ...
        'Invoke-BootEntryRegistration', 'Invoke-LogFinalization')
}
